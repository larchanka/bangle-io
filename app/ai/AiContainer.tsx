      ...
      <Div className="flex flex-col flex-grow h-full overflow-y-scroll text-colorNeutralTextSubdued p-2">
        ...
        >
          ...
          <Div className="p-1">
            ...
            знать или неправильно интерпретировать некоторые вещи, а также
            допускать ошибки. Поэтому, пожалуйста, проверяйте информацию,
            полученную от нее, и не полагайтесь на нее слепо.
          </Div>
        </Div>
      </Div>
    );
